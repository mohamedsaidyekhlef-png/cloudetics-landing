...
export default function Home() {
  ...
  async function askAgro() {
    ...
    try {
      ...
      setReply("Error contacting Agro 2.0.");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <main>
      ...
      <section id="notify" className="notify-section">
        ...
        <form
          className="notify-form validate"
      ...
      <section className="notify-section">
        ...
        <div style={{ marginTop: 15, textAlign: "left", color: "var(--muted)", fontSize: 15 }}>
          {reply}
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer>
        &copy; <span>{year}</span> Cloudetics. All rights reserved.
      </footer>
    </main>
  );
}
